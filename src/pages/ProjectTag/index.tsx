    ...
    <PageContainer>
      <ProTable<APIV2.ProjcetTagListItem, APIV2.ProjectTagFindAllParams>
        ...
        toolBarRender={() => [
          ...
          >
            <PlusOutlined /> <FormattedMessage id="pages.projectTagTable.createForm.newTag" defaultMessage="New" />
          </Button>,
        ]}
        rowKey="id"
      ...
      <ModalForm<APIV2.ProjcetTagListItem>
        title={intl.formatMessage({
            id: 'pages.projectTagTable.createForm.newTag',
            defaultMessage: 'pages.projectTagTable.createForm.newTag',
        })}
        width="400px"
