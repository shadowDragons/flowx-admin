export default {
  ...
  'pages.projectTable.title': '项目',
  'pages.projectTable.name': '名称',
  'pages.projectTable.description': '项目描述',
  'pages.projectTable.tags': '标签',
  'pages.projectTable.skills': '技能',
  'pages.projectTable.imgs': '图片',
